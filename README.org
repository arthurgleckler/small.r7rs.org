...
etc.  Our Trac server was at http://trac.sacrideo.us/, and was hosted
by Aaron Hsu.
...
static web site now hosted at https://small.r7rs.org/.  I made it just
good enough to extract our data in a usable form once and for all.
